...
**
** Created: Tue Mar 26 19:47:52 2019
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.3)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../login/modifyPwdWidget.h"
...
static const char qt_meta_stringdata_modifyPwdWidget[] = {
    "modifyPwdWidget\0\0sureBtn_clicked()\0"
};

const QMetaObject modifyPwdWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_modifyPwdWidget,
      qt_meta_data_modifyPwdWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &modifyPwdWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_modifyPwdWidget))
